...
function hub(pattern) {
    ...
    filelist.forEach(function (file, idx) {
        // get the relative directory of this gulpfile
        console.log('file ' + file);
        var directory = process.cwd() + '/' + file.substring(0, file.lastIndexOf("/"));
...
function addSubtask(directory, idx, name, parm1, parm2) {
    ...
    if (Array.isArray(parm1)) {
        ...
        if (parm2) {
            subparm2 = function() {
                console.log('running parm2 ' + JSON.stringify(parm1) + ' ' + directory);
        ...
        subparm1 = function() {
            console.log('running parm1 ' + JSON.stringify(parm1) + ' ' + directory);
            // give the task function the correct working directory
            process.chdir(directory);
            parm1();
        }
