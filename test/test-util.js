 ...
 *
 * Exclude a type example by specifying it as a string. Must match,
 * case-insensitive, one of the _.is*` validation functions in lodash[2].
 *
 ...
 *     match of of lodash's `_.is*` functions, case-insensitive.
 */
module.exports.getAllTypesSans = function ( excludeType ) {
    ...
    var validator = _[ 'is' +                     // First word "is"
        ...
        excludeType.slice( 1 )   .toLowerCase()   // Type word: 2nd-n letters lowercase
    ];
